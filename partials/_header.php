<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="#">Local Site</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto px-2">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="#"><i class="material-icons" style="color:white; font-size:23px">shopping_cart</i></a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="#"><i class="material-icons" style="color:white; font-size:23px">favorite</i></a>
            </li>
        ...
        <div class="row mx-2">
            ...
            <div class="form-inline my-2 my-lg-0 mr-2">
                ...
                <i class="material-icons ml-3" style="color:white;">account_circle</i>
            </div>
